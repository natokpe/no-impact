...
class Config
{
     ...
     */
    private
    $_password_reset_url_token_key = 'token';
    ...
    function __construct(array $config = [])
    {
        $conf = [
            ...
            'customizer'       => Theme::dirConfig('customizer.php'),
        ...
        foreach ($conf as $_ => $__) {
            ...
            switch ($_) {
                ...
                case 'theme':
                    ...
                    $this->_password_reset_url_token_key = $conf[$_]['password_reset_url_token_key'];
                    break;
